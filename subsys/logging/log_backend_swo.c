...
#pragma message "CONFIG_LOG_BACKEND_SWO_FREQ_HZ is too low. SWO clock divider "\
	"is 16-bit. Minimum supported SWO clock frequency is "\
...
static void log_backend_swo_init(void)
{
	...
	/* Enalble access to ITM registers */
	ITM->LAR  = 0xC5ACCE55;
